...
<html lang="en">
	<head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-3491299-1"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'UA-3491299-1');
		</script>
...
<div class="card">
	<div class="card-body">
		...
		<div class="text-center">
			<button class="btn btn-light " onclick="window.open('https://www.powerlanguage.co.uk/wordle/','_blank')">Wordle (original)</button>
			<button class="btn btn-light " onclick="window.open('https://www.devangthakkar.com/wordle_archive/','_blank')">Wordle Archive</button>
			<button class="btn btn-light " onclick="window.open('https://massimobottelli.it/progetti-didattici/wordle/wordle.php','_blank')">Wordle (my clone)</button>
		</div>
		<hr/>
...
<div class="card">
  <div class="card-header" style="text-align: center">
    Massimo Bottelli - <a href="https://massimobottelli.it/progetti-didattici/wordle/solver.php">Wordle Solver</a>
  </div>
  <div class="card-body">
